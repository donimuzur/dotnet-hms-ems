...
namespace Sampoerna.EMS.Website.Controllers
{
    public class SupportDocController : BaseController
    {
        ...
        private SupportDocViewModel GenerateProperties(SupportDocViewModel source, bool update)
        {
            ...
            IEnumerable<Sampoerna.EMS.Core.Enums.FormList> formTypes = Enum.GetValues(typeof(Sampoerna.EMS.Core.Enums.FormList)).Cast<Sampoerna.EMS.Core.Enums.FormList>();
            data.ListForm = from form in formTypes
                            select new SelectListItem
                            {
                                Text = EnumHelper.GetDescription((Enum)Enum.Parse(typeof(Sampoerna.EMS.Core.Enums.FormList), form.ToString())),
