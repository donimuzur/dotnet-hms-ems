...
$('#file-decree-doc-container').on('click', '.add-files', (function () {
    ...
    $('#file-decree-doc-container').append(' <div class="row"><div class="col-sm-9"> ' +
                                 '<input type="file" id="DecreeFiles_' + file_sk + '_" name="DecreeFiles[' + file_sk + ']" class="form-control">' +
...
function uploadSk() {
    ...
    for (var i = 0; i <= file_sk ; i++) {
        var fileName = $('#DecreeFiles_' + i + '_').val();
...
function removeUploadButton(index, obj) {
    if (index > 0) {
        ...
        for (var i = 0; i <= file_sk; i++) {
            $('#file-decree-doc-container').append('<div class="row"><div class="col-sm-9"> ' +
                            '<input type="file" id="DecreeFiles_' + i + '_" name="DecreeFiles[' + i + ']" class="form-control">' +
