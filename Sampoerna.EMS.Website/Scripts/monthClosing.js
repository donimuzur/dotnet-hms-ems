...
$('#file-decree-doc-container').on('click', '.add-files', (function () {
    ...
    $('#file-decree-doc-container').append(' <div class="row"><div class="col-sm-9"> ' +
                                 '<input type="file" id="Details_MonthClosingFiles_' + file_sk + '_" name="Details.MonthClosingFiles[' + file_sk + ']" class="form-control">' +
...
function uploadSk() {
    ...
    for (var i = 0; i <= file_sk ; i++) {
        var fileName = $('#Details_MonthClosingFiles_' + i + '_').val();
...
function removeUploadButton(index, obj) {
    ...
    $('#Details_MonthClosingFiles_' + index + '_').remove();
    obj.remove();
    ...
    for (var i = 0; i <= file_sk; i++) {
        $('#file-decree-doc-container').append('<div class="row"><div class="col-sm-9"> ' +
                        '<input type="file" id="Details_MonthClosingFiles_' + i + '_" name="Details.MonthClosingFiles[' + i + ']" class="form-control">' +
