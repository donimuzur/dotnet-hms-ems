...
$('#file-decree-doc-container').on('click', '.add-files', (function () {
    ...
    $('#file-decree-doc-container').append(' <div class="row"><div class="col-sm-9"> ' +
                                 '<input type="file" id="Detail_Pbck1DecreeDoc_' + file_sk + '_" name="Detail.Pbck1DecreeDoc[' + file_sk + ']" class="form-control">' +
...
function removeUploadButton(index, obj) {
    if (index > 0) {
        ...
        $('#Detail_Pbck1DecreeDoc_' + index + '_').remove();
        obj.remove();
        ...
        for (var i = 0; i <= file_sk; i++) {
            $('#file-decree-doc-container').append('<div class="row"><div class="col-sm-9"> ' +
                            '<input type="file" id="Detail_Pbck1DecreeDoc_' + i + '_" name="Detail.Pbck1DecreeDoc[' + i + ']" class="form-control">' +
