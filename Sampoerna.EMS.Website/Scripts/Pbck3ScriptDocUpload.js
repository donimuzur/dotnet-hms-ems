...
$('#upload-file-sk').click(function () {
    ...
    for (var i = 0; i <= file_sk ; i++) {
        var fileName = $('#Pbck3Back3FileUploadFileList_' + i + '_').val();
...
$('#file-sk-container').on('click', '.add-files', (function () {
    ...
    //                        ' <span>Browse</span>' +
    //                           '<input type="file" id="Pbck3Back3FileUploadFileList_' + file_sk + '_" name="Pbck3Back3FileUploadFileList[' + file_sk + ']" class="file-inputs" data-filename-placement="inside" style="left: -169px; top: 14px;"></a>' +
    //                       '</div><div class="col-sm-3"></div></div>');

    $('#file-sk-container').append(' <div class="row"><div class="col-sm-9"> ' +
                             '<input type="file" id="Pbck3Back3FileUploadFileList_' + file_sk + '_" name="Pbck3Back3FileUploadFileList_[' + file_sk + ']" class="form-control">' +
...
$('#upload-file-sk2').click(function () {
    ...
    for (var i = 0; i <= file_sk2 ; i++) {
        var fileName = $('#Pbck3Ck2FileUploadFileList_' + i + '_').val();
        var name = fileName.replace("C:\\fakepath\\", "");
        if (name != '') {
            poa_sk2.push(name);
        }
...
$('#file-sk-container2').on('click', '.add-files', (function () {
    ...
    //                        '<a class="file-input-wrapper btn btn-grey  file-inputs">' +
    //                        ' <span>Browse</span>' +
    //                           '<input type="file" id="Pbck3Ck2FileUploadFileList_' + file_sk2 + '_" name="Pbck3Ck2FileUploadFileList[' + file_sk2 + ']" class="file-inputs" data-filename-placement="inside" style="left: -169px; top: 14px;"></a>' +
    //                       '</div><div class="col-sm-3"></div></div>');
    $('#file-sk-container2').append(' <div class="row"><div class="col-sm-9"> ' +
                          '<input type="file" id="Pbck3Ck2FileUploadFileList_' + file_sk + '_" name="Pbck3Ck2FileUploadFileList_[' + file_sk2 + ']" class="form-control">' +
...
function removeUploadDocPbck3(obj) {
    $(obj).closest(".row").remove();
}

function removeUploadDocPbck3(obj, modelName, i) {
