    ...
    public partial class EMSWebsiteMapper
    {
        public static void InitializePBCK4()
        {
            ...
            Mapper.CreateMap<Pbck4Dto, Pbck4FormViewModel>().IgnoreAllNonExisting()
               ...
               .ForMember(dest => dest.GovStatusDesc, opt => opt.MapFrom(src => EnumHelper.GetDescription(src.GOV_STATUS)))
               ;
            ...
            Mapper.CreateMap<Pbck4DashBoardViewModel, Pbck4DasboardParamInput>().IgnoreAllNonExisting();
        }
    }
}