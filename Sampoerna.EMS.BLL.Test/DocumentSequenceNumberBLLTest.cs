...
namespace Sampoerna.EMS.BLL.Test
{
    ...
    public class DocumentSequenceNumberBLLTest
    {
        ...
        public void GenerateNumber_WhenValidInput_GenerateDocumentNumber()
        {
            ...
            string expectedResult = (docNumberSeq.DOC_NUMBER_SEQ_LAST + 1).ToString() + "/" + t001k.T001.BUTXT_ALIAS + "/" + t001k.T001W.ZAIDM_EX_NPPBKC.CITY_ALIAS + "/" + MonthHelper.ConvertToRomansNumeral(input.Month) + "/" + input.Year.ToString();
