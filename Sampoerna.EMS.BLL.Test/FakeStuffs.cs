...
namespace Sampoerna.EMS.BLL.Test
{
    public class FakeStuffs
    {
        ...
        public static IEnumerable<PRODUCTION> GetDailyProductionList()
        {
            var fakeData = new List<PRODUCTION>();
            fakeData.Add(new PRODUCTION
            {
                COMPANY_CODE = "1616",
                WERKS = "ID01",
                FA_CODE = "FA0XXX",
                BRAND_DESC = "MARLBORO BLACK MENTHOL 20"
            });
