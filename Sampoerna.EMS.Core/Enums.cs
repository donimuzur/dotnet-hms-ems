...
namespace Sampoerna.EMS.Core
{
	public class Enums
	{
		...
		{
			[Description("Excise Request")]
			ExciseRequest = 1,
			[Description("Product Development")]
			ProdDev = 2,
			[Description("Brand Request")]
			BrandReq = 3,
			[Description("SKEP Penetapan Tarif")]
			SKEP = 4,
			[Description("Interview Location Request")]
			Interview = 5,
			[Description("License Request")]
			License = 6,
			[Description("Perubahan Dokumen")]
			Change = 7
		}
		...
		public enum ProductDevelopmentAction
		{
			[Description("New Brand")]
			NewBrand = 1,
			[Description("Update HJE")]
			UpdateHJE = 2,
			[Description("Map SKEP")]
			MapSKEP = 3,
			[Description("Penetapan SKEP")]
			PenetapanSKEP = 4     
		}
		...
		{
			[Description("New Brand Registration")]
			NewBrand = 1,
			[Description("Update HJE")]
			UpdateHJE = 2,
