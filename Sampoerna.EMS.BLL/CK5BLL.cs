...
namespace Sampoerna.EMS.BLL
{
    public class CK5BLL : ICK5BLL
    {
        ...
        private string BuildBodyMail(CK5Dto ck5Dto, string webRootUrl)
        {
            var bodyMail = new StringBuilder();
        ...
        private MailNotification ProsesMailNotificationBody(CK5Dto ck5Dto, CK5WorkflowDocumentInput input)
        {
            ...
            bodyMail.Append(BuildBodyMail(ck5Dto, webRootUrl));
        ...
        {
            var bodyMail = new StringBuilder();
            var supplier = pbck1Data.SupplierPlantWerks;
            ...
            {
                supplier = pbck1Data.SupplierPlant;
            }
            
            bodyMail.Append("<tr><td>Plant & NPPBKC Supplier </td><td>: " + supplier + " - " +
                            pbck1Data.SupplierNppbkcId + "</td></tr>");
