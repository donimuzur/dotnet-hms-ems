...
namespace Sampoerna.EMS.BLL.Services
{
    public class LACK1Service : ILACK1Service
    {
        ...
        {
            var incTables = includeTables + ", LACK1_DOCUMENT, LACK1_CALCULATION_DETAIL , LACK1_PERIOD_SUMMARY, LACK1_INCOME_DETAIL, LACK1_INCOME_DETAIL.CK5, LACK1_INCOME_DETAIL.CK5.UOM, LACK1_PLANT, LACK1_PRODUCTION_DETAIL, LACK1_PRODUCTION_DETAIL.UOM, LACK1_PBCK1_MAPPING, LACK1_PBCK1_MAPPING.PBCK1, LACK1_TRACKING";
        ...
        {
            const string incTables = "UOM, UOM1, MONTH, LACK1_PLANT, LACK1_PBCK1_MAPPING, LACK1_PBCK1_MAPPING.PBCK1";
            //process QueryFilter
            Expression<Func<LACK1, bool>> queryFilter = PredicateHelper.True<LACK1>();
        ...
        public List<LACK1> GetDashboardDataByParam(Lack1GetDashboardDataByParamInput input)
        {
            var queryFilter = PredicateHelper.True<LACK1>();
            if (input.PeriodMonth.HasValue)
            {
            ...
            else
            {
                queryFilter = queryFilter.And(c => (c.CREATED_BY == input.UserId) ||
                    (input.ListUserPlant.Contains(c.LACK1_PLANT.FirstOrDefault().PLANT_ID) && c.LACK1_LEVEL == Enums.Lack1Level.Plant) ||
                                                    (input.ListNppbkc.Contains(c.NPPBKC_ID) && c.LACK1_LEVEL == Enums.Lack1Level.Nppbkc));
            }
