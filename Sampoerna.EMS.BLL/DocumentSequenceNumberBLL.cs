...
namespace Sampoerna.EMS.BLL
{
    public class DocumentSequenceNumberBLL : IDocumentSequenceNumberBLL
    {
        ...
        public string GenerateNumber(GenerateDocNumberInput input)
        {
            ...
            //generate number
            string rc = lastSeqData.DOC_NUMBER_SEQ_LAST.ToString("00000") + "/" + ((t001Data != null && t001Data.T001 != null) ? t001Data.T001.BUTXT : "-") + "/" + (t001Data != null && t001Data.T001W != null && t001Data.T001W.ZAIDM_EX_NPPBKC != null ? t001Data.T001W.ZAIDM_EX_NPPBKC.CITY_ALIAS : "-") + "/" + MonthHelper.ConvertToRomansNumeral(input.Month) + "/" + input.Year.ToString();
