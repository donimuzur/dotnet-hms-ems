    ...
    public partial class BLLMapper
    {
        public static void InitializeCK5()
        {
            ...
            Mapper.CreateMap<CK5FileDocumentDto, CK5Dto>().IgnoreAllNonExisting()
                ...
                .ForMember(dest => dest.PACKAGE_UOM_ID, opt => opt.MapFrom(src => src.Uom))
                ;
            ...
            Mapper.CreateMap<CK5, Ck5SummaryReportDto>().IgnoreAllNonExisting()
                ...
                .ForMember(dest => dest.SourcePlant, opt => opt.MapFrom(src => src.SOURCE_PLANT_NAME))
                .ForMember(dest => dest.DestinationPlantId, opt => opt.MapFrom(src => src.DEST_PLANT_ID))
                .ForMember(dest => dest.DestinationPlant, opt => opt.MapFrom(src => src.DEST_PLANT_NAME))
