        ...
        public static void InitializePbck7And3()
        {
            ...
            Mapper.CreateMap<PBCK3_PBCK7, Pbck7AndPbck3Dto>().IgnoreAllNonExisting()
                ...
                .ForMember(dest => dest.ModifiedDate, opt => opt.MapFrom(src => src.MODIFIED_DATE))
                 .ForMember(dest => dest.UploadItems, opt => opt.MapFrom(src => src.PBCK3_PBCK7_ITEM))
                ;
            ...
            Mapper.CreateMap<Pbck7ItemUpload, PBCK3_PBCK7_ITEM>().IgnoreAllNonExisting()
             ...
             .ForMember(dest => dest.BACK1_QTY, opt => opt.MapFrom(src => src.Back1Qty))
                ;
            Mapper.CreateMap<PBCK3_PBCK7_ITEM, Pbck7ItemUpload>().IgnoreAllNonExisting()
           .ForMember(dest => dest.Id, opt => opt.MapFrom(src => src.PBCK3_PBCK7_ITEM_ID))
           ...
           .ForMember(dest => dest.Back1Qty, opt => opt.MapFrom(src => src.BACK1_QTY))
            ...
            Mapper.CreateMap<Pbck7AndPbck3Dto, PBCK3_PBCK7>().IgnoreAllNonExisting()
                ...
                .ForMember(dest => dest.NPPBCK_ID, opt => opt.MapFrom(src => src.NppbkcId))
